...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Define the :Fmt command to format manually
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.animate').setup {
        scroll = {
          enable = true,
          timing = require('mini.animate').gen_timing.linear { duration = 100, unit = 'total' }, -- 100ms duration for scroll animation
        },
      }
  ...
  },
  {
    ...
    init = function()
      ...
      end, { desc = 'Comment toggle current line', noremap = true, silent = true })
      vim.keymap.set({ 'n', 'o' }, 'gc', function()
        require('Comment.api').toggle.linewise()
      end, { desc = 'Comment toggle linewise', noremap = true, silent = true })
      vim.keymap.set('x', 'gc', function()
        require('Comment.api').toggle.linewise(vim.fn.visualmode())
      end, { desc = 'Comment toggle linewise (visual)', noremap = true, silent = true })
      vim.keymap.set('n', 'gbc', function()
        require('Comment.api').toggle.blockwise.current()
      end, { desc = 'Comment toggle current block', noremap = true, silent = true })
      vim.keymap.set({ 'n', 'o' }, 'gb', function()
        require('Comment.api').toggle.blockwise()
      end, { desc = 'Comment toggle blockwise', noremap = true, silent = true })
      vim.keymap.set('x', 'gb', function()
        require('Comment.api').toggle.blockwise(vim.fn.visualmode())
      end, { desc = 'Comment toggle blockwise (visual)', noremap = true, silent = true })
    end,
